...
function mag_news_action_list_opp() {

  register_widget( 'mag_news_list_opp' );
  
}
add_action( 'widgets_init', 'mag_news_action_list_opp' );

class mag_news_list_opp extends WP_Widget{ 

	function __construct() {
		global $control_ops;
		$widget_ops = array(
		  'classname'   => 'business-opp',
		  'description' => esc_html__( 'Add Widget to Display List Opposite Post.', 'mag-news' )
		);
		parent::__construct( 'mag_news_list_column_opp',esc_html__( 'MN: List Opposite', 'mag-news' ), $widget_ops, $control_ops );
	}
	        ...
	        if ($the_query->have_posts()) : $count= 0; ?>
                ...
                <div class="alternate">
                	<?php while ( $the_query->have_posts() ) : $the_query->the_post();
	                    ...
	                    <article class="featured-post post hentry <?php echo esc_attr( $image_class );?>">
