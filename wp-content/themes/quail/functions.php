...
function quail_admin_enqueue($hook){
	if($hook == 'post.php' || $hook == 'post-new.php' || $hook == 'edit.php'){
	    ...
	    wp_enqueue_script( 'quail-admin-script', get_template_directory_uri().'/assets/admin/js/scripts.js','', '1.0.0' , 'all' ); 
	}
	     wp_enqueue_style( 'quail-admin-style', get_template_directory_uri() . '/assets/admin/css/admin-style.css', array(), '1.0.0' );
}
