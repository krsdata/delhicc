                  ...
                  <div class="summary">
                        ...
                        <ul class="list-inline">
                          ...
                          <?php if( in_array( 'number_of_comments', $post_details ) ) { ?>
                            <li>
                              ...
                              <?php comments_popup_link( __( 'zero comment', 'bootstrap-beauty' ), __( 'one comment', 'bootstrap-beauty' ), __( '% comments', 'bootstrap-beauty' ) ); ?>
                            </li>
                          <?php } ?>
                    ...
                    <?php if( in_array( 'read-more', $post_details ) ) { ?>
                      ...
                      <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="" class="readmore">
                        <?php esc_html_e( 'Read More','bootstrap-beauty' ); ?>                
                      </a>
                    <?php } ?>
