...
if ( ! class_exists( 'Bootstrap_Beauty_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Bootstrap_Beauty_Demo {

		/**
		 * Singleton instance of Bootstrap_Beauty_Demo.
		 *
		 * @var Bootstrap_Beauty_Demo $instance Bootstrap_Beauty_Demo instance.
		 */
		...
		/**
		 * Main Bootstrap_Beauty_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Bootstrap_Beauty_Demo ) ) {
				self::$instance = new Bootstrap_Beauty_Demo();
