		 ...
		 <div id="navigation-menu" class="relative">
            <div class="wrapper">
                <button class="primary-menu-toggle" aria-controls="primary-menu" aria-expanded="false">
                    <?php
						echo blog_page_get_svg( array( 'icon' => 'menu', 'class' => 'icon-menu-bar' ) );
						echo blog_page_get_svg( array( 'icon' => 'close' ) );
					?>
                </button><!-- .menu-toggle -->

                <nav id="site-navigation" class="main-navigation main-navigate" role="navigation">
					<?php  
						$search = '';
						if ( $options['nav_search_enable'] ) :
							$search = '<li class="search-menu"><a href="#">';
							$search .= blog_page_get_svg( array( 'icon' => 'search' ) );
							$search .= blog_page_get_svg( array( 'icon' => 'close' ) );
