...
add_action( 'admin_notices', 'vw_photography_activation_notice' );
}

add_action( 'after_setup_theme', 'vw_photography_setup' );

// Notice after Theme Activation
function vw_photography_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-photography' ) .'</h3>';
	echo '<p>'. esc_html__( 'Thank you for choosing VW Photography Theme. Would like to have you on our Welcome page so that you can reap all the benefits of our VW Photography Theme.', 'vw-photography' ) .'</p>';
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=vw_photography_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-photography' ) .'</a></p>';
	echo '</div>';
}
...
//define
define('VW_PHOTOGRAPHY_FREE_THEME_DOC','https://www.vwthemesdemo.com/docs/free-vw-photography/','vw-photography');
define('VW_PHOTOGRAPHY_SUPPORT','https://wordpress.org/support/theme/vw-photography/','vw-photography');
define('VW_PHOTOGRAPHY_REVIEW','https://wordpress.org/support/theme/vw-photography/reviews/','vw-photography');
define('VW_PHOTOGRAPHY_BUY_NOW','https://www.vwthemes.com/themes/wordpress-photography-themes/','vw-photography');
define('VW_PHOTOGRAPHY_LIVE_DEMO','https://www.vwthemes.net/vw-photography-pro/','vw-photography');
define('VW_PHOTOGRAPHY_PRO_DOC','https://www.vwthemesdemo.com/docs/vw-photography-pro/','vw-photography');
define('VW_PHOTOGRAPHY_FAQ','https://www.vwthemes.com/faqs/','vw-photography');
define('VW_PHOTOGRAPHY_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-photography');
define('VW_PHOTOGRAPHY_CONTACT','https://www.vwthemes.com/contact/','vw-photography');
...
if ( ! function_exists( 'vw_photography_credit' ) ) {
	function vw_photography_credit(){
		echo "<a href=".esc_url(VW_PHOTOGRAPHY_CREDIT).">".esc_html__('Photography WordPress Theme','vw-photography')."</a>";
	}
}
