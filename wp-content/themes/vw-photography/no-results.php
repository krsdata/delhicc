...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<a class="error-btn" href="<?php echo esc_url(home_url() ); ?>"><?php esc_html_e( 'Back to Home Page', 'vw-photography' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page','vw-photography' );?></span></a>
<?php endif; ?>