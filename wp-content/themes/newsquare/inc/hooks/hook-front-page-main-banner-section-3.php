<?php
if (!function_exists('magazined_front_page_main_section_3')) :
    /**
     * Banner Slider
     *
     ...
     *
     */
    function magazined_front_page_main_section_3()
    {
...
add_action('magazined_action_front_page_main_section_3', 'magazined_front_page_main_section_3', 40);